...
#指定找到文件后，另存为的文件夹路径
outDir = os.path.abspath("D:\\datasets\\sea_urchin_datasets\\sea_urchin\\labeled_img") 

#指定第一个文件夹的位置
imageDir1 = os.path.abspath("D:\\datasets\\sea_urchin_datasets\\sea_urchin\\Echinometra_mathaei\\original_img\\")
...
#对于第二个文件夹路径，做同样的操作
imageDir2 = os.path.abspath("D:\\datasets\\sea_urchin_datasets\\sea_urchin\\label_txt\\")
image2 = []
imgname2 = []
